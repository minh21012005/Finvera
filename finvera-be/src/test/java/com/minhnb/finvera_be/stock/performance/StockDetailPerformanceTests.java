...
class StockDetailPerformanceTests {
    ...
    void setUp() {
        ...
        valuationService = new ValuationService(referenceData, dailyBars, profiles, reports, reportMetrics, sectors, assessments, valuationMetrics, assessmentInputs, fundamentalService, FIXED_CLOCK);
