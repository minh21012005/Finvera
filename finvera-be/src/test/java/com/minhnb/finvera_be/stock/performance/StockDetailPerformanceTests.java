...
class StockDetailPerformanceTests {
    ...
    void setUp() {
        ...
        valuationService = new ValuationService(referenceData, dailyBars, profiles, reports, reportMetrics, sectors, assessments, valuationMetrics, assessmentInputs, fundamentalService, ingestion, summaries, summaryMetrics, FIXED_CLOCK, false);
