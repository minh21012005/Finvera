...
/**
 * Shared owner-scoping enforcement primitive (SEC-001, SEC-002, research R-002).
 ...
 */
@Component
public class OwnerScopedAccess {

    private final OwnerProperties ownerProperties;

    public OwnerScopedAccess(OwnerProperties ownerProperties) {
