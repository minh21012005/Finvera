...
const validOverview = {
  ...
  breadth: { dataStatus: "UNAVAILABLE", advancing: null, declining: null, unchanged: null, eligible: null,
    unclassified: null, universeVersion: "breadth-universe-v1", calculationBasis: null, tradingDate: null, asOf: null,
    source: { provider: "UNAVAILABLE", dataset: "BREADTH" }, reasonCodes: ["BREADTH_NOT_AVAILABLE"] },
  regime: {
    dataStatus: "UNAVAILABLE", ruleVersion: "market-regime-v1", assessmentBasis: null, label: null, score: null, confidence: null,
...
describe("market overview API client", () => {
  ...
  it("accepts the provider-compatible market regime v2 rule version", () => {
    ...
    expect(parseMarketOverview(withV2).regime.assessmentBasis).toBe("LIVE");
  });
