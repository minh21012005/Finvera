...
export const REASON_CODE_LABELS: Readonly<Record<string, string>> = {
  ...
  "vci-current-ratio-v1": "Thanh toán hiện hành = tài sản ngắn hạn ÷ nợ ngắn hạn (quy tắc vci-current-ratio-v1)",
  "vci-quick-ratio-v1": "Thanh toán nhanh = (tài sản ngắn hạn − hàng tồn kho) ÷ nợ ngắn hạn (quy tắc vci-quick-ratio-v1)",
  "vci-cash-ratio-v1": "Thanh toán tiền mặt = tiền và tương đương tiền ÷ nợ ngắn hạn (quy tắc vci-cash-ratio-v1)",
  "vci-debt-to-assets-v1": "Nợ vay/Tổng tài sản = (vay ngắn hạn + dài hạn) ÷ tổng tài sản × 100 (quy tắc vci-debt-to-assets-v1)",
  "vci-liabilities-to-equity-v1": "Nợ phải trả/Vốn chủ = tổng nợ phải trả ÷ vốn chủ sở hữu × 100 (quy tắc vci-liabilities-to-equity-v1)",
  "vci-equity-to-assets-v1": "Vốn chủ/Tổng tài sản = vốn chủ sở hữu ÷ tổng tài sản × 100 (quy tắc vci-equity-to-assets-v1)",
  "vci-interest-coverage-v1": "Khả năng trả lãi = (LN trước thuế + chi phí lãi vay) ÷ chi phí lãi vay (quy tắc vci-interest-coverage-v1)",
  "vci-asset-turnover-v1": "Vòng quay tổng tài sản = doanh thu (năm/4 quý) ÷ tổng tài sản bình quân (quy tắc vci-asset-turnover-v1)",
  "vci-asset-turnover-v1-end": "Vòng quay tổng tài sản dùng số dư cuối kỳ — chưa đủ số dư để lấy bình quân (quy tắc vci-asset-turnover-v1-end)",
  "vci-inventory-turnover-v1": "Vòng quay tồn kho = giá vốn hàng bán ÷ hàng tồn kho bình quân (quy tắc vci-inventory-turnover-v1)",
  "vci-inventory-turnover-v1-end": "Vòng quay tồn kho dùng số dư cuối kỳ — chưa đủ số dư để lấy bình quân (quy tắc vci-inventory-turnover-v1-end)",
  "vci-receivables-turnover-v1": "Vòng quay phải thu = doanh thu ÷ phải thu khách hàng bình quân (quy tắc vci-receivables-turnover-v1)",
  "vci-receivables-turnover-v1-end": "Vòng quay phải thu dùng số dư cuối kỳ — chưa đủ số dư để lấy bình quân (quy tắc vci-receivables-turnover-v1-end)",
  "vci-roce-v1": "ROCE = (LN trước thuế + lãi vay) ÷ (tổng tài sản − nợ ngắn hạn) bình quân × 100 (quy tắc vci-roce-v1)",
  "vci-roce-v1-end": "ROCE dùng số dư cuối kỳ — chưa đủ số dư để lấy bình quân (quy tắc vci-roce-v1-end)",
  "vci-balance-growth-yoy-v1": "Tăng trưởng so với cuối năm trước × 100 (quy tắc vci-balance-growth-yoy-v1)",
  "vci-nim-earning-assets-v1": "NIM = thu nhập lãi thuần ÷ tài sản sinh lãi bình quân (tiền gửi/cho vay TCTD khác + CK kinh doanh + CK đầu tư + cho vay khách hàng thuần) × 100 (quy tắc vci-nim-earning-assets-v1)",
  "vci-nim-earning-assets-v1-end": "NIM dùng tài sản sinh lãi cuối kỳ — chưa đủ số dư để lấy bình quân (quy tắc vci-nim-earning-assets-v1-end)",
  "vci-cir-v1": "CIR = chi phí quản lý ÷ tổng thu nhập hoạt động × 100 (quy tắc vci-cir-v1)",
  "vci-dps-cash-dividends-over-shares-v1": "Cổ tức tiền/CP = │cổ tức tiền đã trả│ ÷ số CP lưu hành kỳ đó (quy tắc vci-dps-cash-dividends-over-shares-v1)",
  "vci-ldr-v1": "LDR = dư nợ cho vay khách hàng ÷ tiền gửi khách hàng × 100 (quy tắc vci-ldr-v1)",
  ...
  MISSING_REVENUE: "Thiếu doanh thu 4 quý để tính P/S",
  NEGATIVE_OR_ZERO_REVENUE: "Doanh thu âm hoặc bằng 0",
  MISSING_MARKET_CAP_INPUTS: "Thiếu giá hoặc số cổ phiếu để tính vốn hóa",
