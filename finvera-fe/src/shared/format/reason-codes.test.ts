...
const INVENTORY = [
  ...
  "INSUFFICIENT_METRIC_COVERAGE", "REDUCED_METRIC_SET", "HISTORY_SHARES_OUTSTANDING_HELD_CURRENT",
  "HISTORY_FISCAL_YEAR_BASIS", "HISTORY_COMPARISON_UNAVAILABLE", "MISSING_EPS",
