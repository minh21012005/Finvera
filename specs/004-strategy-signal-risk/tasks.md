...
- [ ] T001 [P] Add `findCurrentRegimeAssessment` to
      ...
      Depends: none
- [ ] T002 [P] Write migration tests for `strategy_signal`,
      ...
      Depends: none
- [ ] T003 Create the forward-only Flyway migration
      ...
      Depends: T002
- [ ] T004 [P] Write the full `strategy-signal-v1` required-test-vector
      ...
      Depends: none
- [ ] T005 Implement the `strategy-signal-v1` engine — eight entry
      ...
      Depends: T001, T004
- [ ] T006 [P] Add bulk/current-plus-prior-day finder methods needed by the
...
- [ ] T007 [P] [US1] Write persistence tests — signal created only on a
      ...
      Depends: T003, T005
- [ ] T008 [P] [US1] Write owner-only contract/security tests (including a
...
- [ ] T009 [US1] Implement `StrategySignalService` — evaluate all eight
      ...
      Depends: T006, T007
- [ ] T010 [US1] Implement DTO mapping and controller for
      ...
      passes
      Depends: T008, T009
- [ ] T011 [P] [US1] Implement browser API types, runtime response
      ...
      Depends: T010
- [ ] T012 [P] [US1] Write signal-section component tests — signal display,
      ...
      Depends: none
- [ ] T013 [US1] Implement the accessible signals section (extends the
      ...
      passes
      Depends: T011, T012
- [ ] T014 [US1] Add Playwright P1 journeys — triggered signal, no-signal
...
- [ ] T015 [P] [US2] Write risk-factor display tests — six factors shown
...
- [ ] T016 [US2] Implement the risk-factor breakdown display within
      ...
      passes
      Depends: T013, T015
- [ ] T017 [US2] Add Playwright P2 journeys — full factor breakdown,
...
- [ ] T018 [P] [US3] Write scan orchestration tests — exact match set,
      ...
      Verify: fails before the service exists
      Depends: T005
- [ ] T019 [P] [US3] Write owner-only contract/security tests for
...
- [ ] T020 [US3] Implement `StrategyScanService`, reusing Feature 003's
      ...
      passes
      Depends: T006, T018
- [ ] T021 [US3] Implement DTO mapping and controller for
      `POST /strategies/{strategyCode}/scan` in
      ...
      passes
      Depends: T019, T020
- [ ] T022 [P] [US3] Implement browser API client (CSRF-attaching from the
      start) in `finvera-fe/src/features/stock-strategy/api/stock-strategy.ts`
      Verify: frontend unit tests reject malformed responses
      Depends: T021
- [ ] T023 [P] [US3] Write strategy-picker and scan-results component tests
      in `finvera-fe/src/features/stock-strategy/strategy-scan.test.tsx`
      Verify: fails before the components exist
      Depends: none
- [ ] T024 [US3] Implement the strategy scan page (mirrors Feature 003's
      ...
      Depends: T022, T023
- [ ] T025 [US3] Add Playwright P3 journeys — exact match set, empty
...
- [ ] T026 Run and reconcile all contract tests; update
...
- [ ] T027 Add a latency smoke test (NFR-001/NFR-002) in
      ...
      Depends: T009, T020
- [ ] T028 Add fault-injection tests — cross-source conflict withholding a
      ...
      Depends: T009, T020
- [ ] T029 Add the replay-determinism test — identical inputs/rule version
      ...
      Depends: T009
- [ ] T030 Add owner/unauthenticated negative security tests for both
      endpoints (including CSRF) plus a `finvera-fe/dist` secret scan
      Verify: only the owner succeeds; no credential in the bundle
      Depends: T010, T021
- [ ] T031 Execute and record the fixture-mode commands/scenarios in
...
- [ ] T032 Reconcile delivered behavior and open limitations in `spec.md`,
      ...
      Depends: T031
- [ ] T033 Run repository quality gates from `finvera-be/` and `finvera-fe/`
      Verify: `.\mvnw.cmd test`, `npm run lint`, `npm run test`,
      `npm run build`, `npm run test:e2e` all pass
      Depends: T032
- [ ] T034 Perform the manual cross-artifact analysis pass (mirroring
