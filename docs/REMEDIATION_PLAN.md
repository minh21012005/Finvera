...
| **Q-46** | `DONE` (2026-08-31) | Low | `MEASURED` | `EPS_TTM` silently fell back to the provider's `TRAILING_EPS` when quarterly EPS was absent (banks, securities); value correct, basis undisclosed. Now labelled `PROVIDER_TRAILING_EPS` (specs/010 research R-005 amendment). |
...
| Breadth 2026-08-28 (advance/decline vs prior close over the 1,524 current profiles) | 1 | **326/375/243/580/1,524 exact** |
